...
test('greeting message should be correct for city', () => {
    ...
    // expect(message).toBe('Hello New York citiziens. I want you be happy. All 1000000 men')
    expect(createMessage(city)).toBe('Hello New York citiziens. I want you be happy. All 1000000 men')
})